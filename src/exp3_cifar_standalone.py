...
from models_cifar import CNNClassifier
...
print("=" * 60)
print("Exp3-CIFAR: Standalone CNN classifier (same structure as VAE encoder) for 50 epochs")
print("=" * 60)
