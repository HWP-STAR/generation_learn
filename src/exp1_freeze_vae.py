...
# ========= Phase 1: 无监督训练 VAE 50 epochs =========
vae = VAE(latent_dim=latent_dim).to(device)
optimizer = optim.Adam(vae.parameters(), lr=1e-3)

print("=" * 60)
print("Exp1 Phase 1: Training VAE for 50 epochs (unsupervised)")
print("=" * 60)
...
torch.save(vae.state_dict(), "checkpoints/vae_50epochs.pth")
print("VAE saved to checkpoints/vae_50epochs.pth\n")

with open("results/exp1_vae_loss.txt", "w") as f:
...
print("=" * 60)
print("Exp1 Phase 2: Training classifier (encoder frozen) for 50 epochs")
print("=" * 60)
...
print("Results saved to results/exp1_results.txt")
