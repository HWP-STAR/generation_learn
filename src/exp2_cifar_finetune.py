...
from models_cifar import CNNVAE
...
vae.load_state_dict(torch.load("checkpoints/vae_cifar_50epochs.pth"))
...
print("=" * 60)
print("Exp2-CIFAR: Fine-tune CNN VAE encoder + classifier for 50 epochs")
print("=" * 60)
